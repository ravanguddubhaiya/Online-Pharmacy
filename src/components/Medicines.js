...
export default function Medcines({ medicinePanigation, sort }) {
  if (!medicinePanigation) {
    return;
  }
  const medicineSort = [...medicinePanigation];

  if (sort === "DownToUp") {
    medicineSort.sort((a, b) => {
