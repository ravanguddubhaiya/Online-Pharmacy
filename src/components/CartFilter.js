...
export default function CartFilter() {
  ...
  const handleShowQuantity = (medicine, quantity) => {
    dispatch(showQuantity(medicine, quantity));
  };
  ...
  const handleDecrement = (medicine) => {
    dispatch(decrementItem(medicine));
      ...
      <table className="table">
        <thead className="bg-light">
          <tr className="text-center">
            ...
            <th className="border-0" scope="col">
              {" "}
              <strong className="text-small text-uppercase">Medicine</strong>
            </th>
            <th className="border-0" scope="col">
              {" "}
          ...
          {carts.map((item, index) => (
            <Fragment key={index}>
              <tr className="text-center">
                ...
                <td className="align-middle border-0">
                  <p className="mb-0 small">${item.medicine.price}</p>
                </td>
                <td className="align-middle border-0">
                ...
                <td className="align-middle border-0">
                  <p className="mb-0 small">
                    ${parseInt(item.quantity) * parseInt(item.medicine.price)}
                  </p>
                </td>
                <td className="align-middle border-0">
                  <a
